...
//	Annotation que verifica se o CPF é válido
	@CPF
	@Column(unique = true)
...
//	Assegurar que a lista de perfil virá quando o usuario for chamado
	...
	public Pessoa() {
		super();
//		Qualquer usuario criado sem informar o perfil será setado automaticamente como cliente
